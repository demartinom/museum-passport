...
// func (m *MockMuseumClient) GeneralSearch(string, int) (*museums.SearchResult, error) {
// 	return &museums.SearchResult{}, nil
// }
...
// var mockArtwork = &models.SingleArtwork{
// 	ID:           "met-123",
...
// 			"met": &MockMuseumClient{artwork: mockArtwork},
// 		},
// 	}
...
// 	handler := &ArtworkHandler{
// 		Clients: map[string]museums.Client{
// 			"guggenheim": &MockMuseumClient{artwork: mockArtwork},
// 		},
// 	}
